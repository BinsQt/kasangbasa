              ...
              {slide.images && (
                <div className="flex justify-center items-center gap-4 md:gap-10 flex-wrap mt-5">
                  {slide.images.map((img, index) => (
                    <img alt='#' key={index} src={img} className="w-full md:w-auto h-auto max-h-80 rounded-lg shadow-md object-contain" onError={(e) => { e.target.onerror = null; e.target.src = `https://placehold.co/300x200/cccccc/000000?text=Image+Not+Found`; }} />
                  ))}
                </div>
              )}
            </div>
            ...
            <div className={`${glassmorphismClasses}`}>
              ...
              {slide.images && (
                <div className="flex justify-center items-center flex-wrap mt-5">
                  {slide.images.map((img, index) => (
                    <img alt='#' key={index} src={img} className="w-full md:w-auto h-auto max-h-60 rounded-lg shadow-md object-contain" onError={(e) => { e.target.onerror = null; e.target.src = `https://placehold.co/300x200/cccccc/000000?text=Image+Not+Found`; }} />
                  ))}
                </div>
              )}
            </div>
            ...
            <div className={`${glassmorphismClasses} flex flex-col items-center text-center`}>
              {slide.images && (
                <div className="flex justify-center items-center flex-wrap gap-4 md:gap-10 mb-5">
                  {slide.images.map((img, index) => (
                    <img alt='#' key={index} src={img} className="w-40 h-auto rounded-lg shadow-md object-contain" onError={(e) => { e.target.onerror = null; e.target.src = `https://placehold.co/160x160/cccccc/000000?text=Image+Not+Found`; }} />
                  ))}
                </div>
              )}
              <h2 className="text-3xl md:text-5xl font-bold mb-4 text-blue-600">{slide.title}</h2>
          ...
          <div className="w-full max-w-4xl mx-auto px-4 py-8">
            <div className={`${glassmorphismClasses} flex flex-col items-center text-center`}>
              ...
              {slide.images && (
                <div className="flex justify-center items-center flex-wrap gap-4 md:gap-10 mb-5">
                  {slide.images.map((img, index) => (
                    <img alt='#' key={index} src={img} className="w-40 h-40 rounded-lg shadow-md object-contain" onError={(e) => { e.target.onerror = null; e.target.src = `https://placehold.co/160x160/cccccc/000000?text=Image+Not+Found`; }} />
                  ))}
                </div>
              )}
              {renderParagraphs(slide.content)}
          ...
          <div className="w-full max-w-4xl mx-auto px-4 py-8">
            <div className={`${glassmorphismClasses} flex flex-col items-center text-center`}>
              ...
              {slide.images && (
                <div className="flex justify-center items-center flex-wrap gap-4 md:gap-10 mb-5">
                  {slide.images.map((img, index) => (
                    <img alt='#' key={index} src={img} className="w-full md:w-auto h-auto max-h-40 rounded-lg shadow-md object-contain" onError={(e) => { e.target.onerror = null; e.target.src = `https://placehold.co/160x160/cccccc/000000?text=Image+Not+Found`; }} />
                  ))}
                </div>
              )}
